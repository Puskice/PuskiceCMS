@section('content')
	<div class="row">
		<form method="post" action="{{URL::action('MemeController@postUpdate')}}/{{$meme->id}}">
			<div class="col-md-8">
				<div class="box box-primary">
                    ...
                    <div class="box-body">
                    	<div class="form-group">
		                    ...
		                    <input type="text" name="title" class="form-control" value="{{Input::old('title', $meme->name)}}" />
		                </div>
                    	<div class="form-group">
							...
							<div class="input-group">
	                            ...
	                            <input type="text" class="form-control" id="fileFld" name="url" value="{{Input::old('url', $meme->img)}}" />
	                        </div>
	                    </div>
		            </div>
	            </div>
