@section('content')
	<div class="row">
		<form method="post" action="{{URL::action('SubjectController@postUpdate')}}/{{$article->id}}">
			<div class="col-md-8">
			...
			<div class="col-md-4">
				<div class="box box-primary">
					...
					<div class="box-body">
		                ...
		                @foreach($article->subjects as $key => $subject)
			                <div class="form-group">
			                    <label>{{__(Lang::get('admin.semester'))}} {{$key+1}}</label>
			                    <select class="form-control chosen-select5" name="semester{{$key+1}}">
			                    	<option value="1" @if($subject->semester == 1) selected="selected" @endif>1</option>
			                    	<option value="2" @if($subject->semester == 2) selected="selected" @endif>2</option>
			                    	<option value="3" @if($subject->semester == 3) selected="selected" @endif>3</option>
			                    	<option value="4" @if($subject->semester == 4) selected="selected" @endif>4</option>
			                    	<option value="5" @if($subject->semester == 5) selected="selected" @endif>5</option>
			                    	<option value="6" @if($subject->semester == 6) selected="selected" @endif>6</option>
			                    	<option value="7" @if($subject->semester == 7) selected="selected" @endif>7</option>
			                    	<option value="8" @if($subject->semester == 8) selected="selected" @endif>8</option>
			                    </select>
			                </div>
			                <div class="form-group">
			                    <label>{{__(Lang::get('admin.department'))}} {{$key+1}}</label>
			                    <select class="form-control chosen-select6" name="department{{$key+1}}">
			                    	<option value="0" @if($subject->department == 0) selected="selected" @endif>{{__(Lang::get('admin.zajednickeOsnove'))}}</option>
			                    	<option value="1" @if($subject->department == 1) selected="selected" @endif>{{__(Lang::get('admin.isit'))}}</option>
			                    	<option value="2" @if($subject->department == 2) selected="selected" @endif>{{__(Lang::get('admin.menadzment'))}}</option>
			                    	<option value="3" @if($subject->department == 3) selected="selected" @endif>{{__(Lang::get('admin.operacioni'))}}</option>
			                    	<option value="4" @if($subject->department == 4) selected="selected" @endif>{{__(Lang::get('admin.upravljanjeKvalitetom'))}}</option>
			                    </select>
			                </div>
			                <div class="form-group">
			                    <label>{{__(Lang::get('admin.espb'))}} {{$key+1}}</label>
			                    <select class="form-control chosen-select7" name="espb{{$key+1}}">
			                    	<option value="1" @if($subject->espb == 1) selected="selected" @endif>1</option>
			                    	<option value="2" @if($subject->espb == 2) selected="selected" @endif>2</option>
			                    	<option value="3" @if($subject->espb == 3) selected="selected" @endif>3</option>
			                    	<option value="4" @if($subject->espb == 4) selected="selected" @endif>4</option>
			                    	<option value="5" @if($subject->espb == 5) selected="selected" @endif>5</option>
			                    	<option value="6" @if($subject->espb == 6) selected="selected" @endif>6</option>
			                    </select>
			                </div>
		                @endforeach
		            </div>
