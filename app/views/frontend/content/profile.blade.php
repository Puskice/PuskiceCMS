...
<div class="row">
  <div class="col-md-12 content-container">
    <div class="content">
      <div class="title">
        <h2>{{__("Ажурирајте Пушкице налог")}}</h2>
      </div>
      ...
      <form action="{{_l(URL::action('LoginController@postUpdateProfile'))}}" method="post">
            <div class="body bg-gray">
                <div class="form-group">
                    <input type="text" name="firstName" class="form-control" placeholder="{{__(Lang::get('login.firstName'))}}" value="{{Input::old('firstName', $user->first_name)}}" />
                </div>
                <div class="form-group">
                    <input type="text" name="lastName" class="form-control" placeholder="{{__(Lang::get('login.lastName'))}}" value="{{Input::old('lastName', $user->last_name)}}"/>
                </div>
                <!-- <div class="form-group">
            ...
            <div class="footer">                    
                ...
                <button type="submit" class="btn btn-primary btn-block">{{__("Ажурирајте налог")}}</button>
