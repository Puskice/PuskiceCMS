...
$base_url ="//".$_SERVER['HTTP_HOST'];  // DON'T TOUCH (base url (only domain) of site (without final /)).
if(isset($_SESSION['RF']['upload_dir'])){
  $upload_dir = $_SESSION['RF']['upload_dir']; // path from base_url to base of upload folder (with start and final /)
  $current_path = '../../..'.$_SESSION['RF']['upload_dir']; // relative path from filemanager folder to upload folder (with final /)
  //thumbs folder can't put inside upload folder
  $thumbs_base_path = '../../..'.$_SESSION['RF']['upload_dir'].'.thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)  
}
else{
  $upload_dir = '/repo/vesti/'; // path from base_url to base of upload folder (with start and final /)
  $current_path = '../../../repo/vesti/'; // relative path from filemanager folder to upload folder (with final /)
  //thumbs folder can't put inside upload folder
  $thumbs_base_path = '../../../repo/vesti/.thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
}
...
$access_keys = array(md5(date("m.Y", strtotime("now"))));
